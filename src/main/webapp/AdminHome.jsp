...
<label for="flight_from">source :</label>
<input type="text" name="flight_from" id=source/>
<br><br>
<label for="flight_to">destination :</label>
<input type="text" name="flight_to" id=destination/>
<br><br>
